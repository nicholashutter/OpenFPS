...
[![Tests](https://img.shields.io/badge/tests-1000%20passing-brightgreen.svg)](BUILD.md)
...
**Currently in pre-alpha.** The renderer is built and the demo is playable: a first-person view of a room with a held weapon, at 1280x720. 1000 tests passing, Checkstyle clean, build green.
